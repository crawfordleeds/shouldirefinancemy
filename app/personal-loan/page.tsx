...
function calculateRefinance(
  ...
  // Calculate new loan details (balance + fees rolled in)
  ...
  // Personal loans typically have higher rates, so even 1-2% drop is significant
  if (netSavings > 300 && rateDifference >= 2) {
    ...
    reasons.push("Personal loans typically need at least 1-2% rate reduction");
  } else {
  ...
  if (shouldRefinance === true || shouldRefinance === null) {
    reasons.push("💡 Tip: Refinancing triggers a hard credit inquiry");
  }
...
const faqSchema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "When should I refinance my personal loan?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Consider refinancing your personal loan if you can get a rate at least 1-2% lower than your current rate, your credit score has improved since the original loan, and the fees don't outweigh your savings."
      }
    },
    {
      "@type": "Question",
      "name": "How much can I save by refinancing a personal loan?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Savings depend on your loan balance, rate reduction, and remaining term. A 2% rate reduction on a $10,000 loan with 36 months remaining could save $300-500 in interest."
      }
    },
    {
      "@type": "Question",
      "name": "Are there fees to refinance a personal loan?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Many lenders offer no-fee personal loan refinancing, but some charge origination fees of 1-6% of the loan amount. Always factor fees into your savings calculation."
      }
    },
    {
      "@type": "Question",
      "name": "Will refinancing hurt my credit score?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Refinancing triggers a hard inquiry which may temporarily lower your score by a few points. However, if refinancing helps you manage payments better, it can improve your score long-term."
      }
    }
  ]
};
...
const webAppSchema = {
  ...
  "description": "Calculate whether you should refinance your personal loan with a clear YES or NO recommendation",
...
export default function PersonalLoanRefinancePage() {
  const [loanBalance, setLoanBalance] = useState<string>("10000");
      ...
      <main className="min-h-screen bg-gradient-to-b from-background to-muted/30">
        <div className="container mx-auto px-4 py-8 max-w-4xl">
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Enter your existing personal loan details</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Personal loan rates typically range from 6% to 36%
                  </p>
                </div>
                <div className="space-y-2">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="refinanceFees">Origination/Refinance Fees ($)</Label>
                  <Input
                    id="refinanceFees"
                    type="number"
                    value={refinanceFees}
                  ...
                  />
                  <p className="text-xs text-muted-foreground">
                    Many lenders offer no-fee refinancing. Check your offer.
                  </p>
                </div>
          ...
          <section className="mt-16">
            ...
            <div className="space-y-6">
              <div>
                <h3 className="font-semibold mb-2">When should I refinance my personal loan?</h3>
                <p className="text-muted-foreground">
                  Consider refinancing your personal loan if you can get a rate at least 1-2% lower than 
                  your current rate, your credit score has improved since the original loan, and the fees 
                  don&apos;t outweigh your savings.
                </p>
              </div>
              <div>
                <h3 className="font-semibold mb-2">How much can I save by refinancing a personal loan?</h3>
                <p className="text-muted-foreground">
                  Savings depend on your loan balance, rate reduction, and remaining term. A 2% rate 
                  reduction on a $10,000 loan with 36 months remaining could save $300-500 in interest.
                </p>
              </div>
              <div>
                <h3 className="font-semibold mb-2">Are there fees to refinance a personal loan?</h3>
                <p className="text-muted-foreground">
                  Many lenders offer no-fee personal loan refinancing, but some charge origination fees 
                  of 1-6% of the loan amount. Always factor fees into your savings calculation.
                </p>
              </div>
              <div>
                <h3 className="font-semibold mb-2">Will refinancing hurt my credit score?</h3>
                <p className="text-muted-foreground">
                  Refinancing triggers a hard inquiry which may temporarily lower your score by a few points. 
                  However, if refinancing helps you manage payments better, it can improve your score long-term.
                </p>
              </div>
            </div>
          </section>
